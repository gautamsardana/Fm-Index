...
int main(int argc, char *argv[]) {
  if (argc != 6) {
    cerr << "Usage: " << argv[0] << " <query_file> <build_out> <count_out> <locate_out> [--jacobson|--naive]\n";
    cerr << "Example: " << argv[0] << " queries_50mb.txt experiments/results/build_custom.csv experiments/results/count_custom.csv experiments/results/locate_custom.csv --jacobson\n";
